...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title"> Mihir Patel
        ...
        <p className="home__descritption"> Aspiring to become a full stack developer of "Front-end developer with experience in HTML, CSS, JavaScript, and responsive design."</p>
